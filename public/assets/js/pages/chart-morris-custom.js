...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["#2487ce", "#7759de", "#2ed8b6"]
        });
        ...
        Morris.Bar({
            ...
            ykeys: ['a', 'b', 'c'],
            labels: ['Bar 1', 'Bar 2', 'Bar 3'],
            barColors: ["#FFB64D", "#FF5370", "#2487ce"]
        });
        ...
        Morris.Area({
            ...
            lineColors: ['#2ed8b6', '#7759de', '#2487ce'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            ymin: -1.0,
            ymax: 1.0,
            lineColors: ['#FFB64D', '#FF5370', '#2487ce'],
            pointSize: 4,
            responsive: true,
            pointFillColors: ['#fff', '#fff', '#fff'],
            pointStrokeColors: ['#FFB64D', '#FF5370', '#2487ce'],
            lineWidth: 2,
            hideHover: true
        });
