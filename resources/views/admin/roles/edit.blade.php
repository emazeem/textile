            ...
            <div class="card-footer bg-white border-top">
                ...
                <input type="hidden" value="{{$edit->id}}" name="id">
                    <div class="form-group col-md-3 col-12 ">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{$edit->name}}" placeholder="Name">
                    </div>
                                ...
                                @foreach($parents as $parent)
                                    ...
                                    @foreach($parent->child as $permission)
                                        <div class="form-check form-check-inline">
                                            ...
                                            @endphp
                                            <input class="form-check-input" type="checkbox" {{ $selected }} name="child[]" value="{{$permission->id}}" id="{{$permission->id}}">
